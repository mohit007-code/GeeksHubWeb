<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="GeeksHub.login" %>
...
<body>
	<div id="logincall" class="limiter">
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form">
					...
					<div class="text-right p-t-8 p-b-31">
						<a class="text-lg-left" href="#">Register New Account?</a>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<div class="container-login100-form-btn" >
						<div class="wrap-login100-form-btn">
							...
							<%--<asp:Button ID="Button1" CssClass="login100-form-btn" runat="server" OnClick="Button1_Click" Text="Button" />--%>
